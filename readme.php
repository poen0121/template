...
>> Usage Function
	...
	--------------------------------------------------------------
	Example :
	hpl_template::view('views/example.php',array('content'=>'Test data content.'));
	Output >> TRUE
	Example :
	hpl_template::view('views/example.php',array('content'=>'Test data content.'),true);
